    ...
    <header class="header1">
                                                            ...
                                                            <div class="modal-content">
                                                            	...
                                                            	<div id="content">
	                                                                <div class="modal-header">
	                                                                    <h5><span class="label label-warning" id="qid">1</span> <span id="question"></span></h5>                                                                        <div class="progress" style="width: 100%; height: 20px; margin-top: 10px;">
                                                                            <div id="quiz-progress" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div>
                                                                        </div>	                                                                </div>
        ...
        <script>
            ...
            function loadQuestion(question_data){
                ...
                if (question_data.total) {
                    var progress = Math.round((question_data.current / question_data.total) * 100);
                    $('#quiz-progress').css('width', progress + '%').attr('aria-valuenow', progress).text(progress + '%');
                    $('#qid').text(question_data.current + " / " + question_data.total);
                }
